        ...
        bra_photostream: function(options) {
			...
			function create_html(data, container) {
				...
				$(container).find("li").each(function(){
					...
					pin_url = "../../../www.pinterest.com/" + $(this).find("a").attr("href");
            ...
            return this.each(function() {
				  ...
				  if (o.social_network == "dribbble") {
					  obj.append("<ul></ul>")
					  $.getJSON("../../../dribbble.com/" + o.user + "/shots.json?callback=?", function(data){
				  ...
				  if (o.social_network == "pinterest") {  
					var url = '../../../pinterest.com/' + o.user + '/feed.rss'
				  ...
				  if (o.social_network == "flickr") { 
						obj.append("<ul></ul>")
						$.getJSON("../../../api.flickr.com/services/rest/@method=flickr.people.findByUsername&username=" + o.user+ "&format=json&api_key=85145f20ba1864d8ff559a3971a0a033&jsoncallback=?", function(data){
							var nsid = data.user.nsid;
							$.getJSON("../../../api.flickr.com/services/rest/@method=flickr.photos.search&user_id=" + nsid + "&format=json&api_key=85145f20ba1864d8ff559a3971a0a033&per_page=" + o.limit + "&page=1&extras=url_sq&jsoncallback=?", function(data){
								$.each(data.photos.photo, function(i,img){
									var img_owner = img.owner;
									var img_title = img.title;
									var img_src = img.url_sq;
									var img_id = img.id;
									var img_url = "../../../www.flickr.com/photos/" + img_owner + "/" + img_id;

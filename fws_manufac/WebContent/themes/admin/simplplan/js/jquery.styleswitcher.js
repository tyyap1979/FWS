...
//-------------------------------------------------------------- */
	...
	if($.cookie("width")) {
		// Sets the width that the cookie finds
		$("link.width").attr("href",("http://www.forestwebsolution.com/themes/admin/simplplan/css/" + $.cookie("width") + ".css"));
	};
	...
	$("#width li a").click(function() { 
		...
		var $widthCss = "http://www.forestwebsolution.com/themes/admin/simplplan/css/" + ($(this).attr('href').replace("#","")) + ".css";

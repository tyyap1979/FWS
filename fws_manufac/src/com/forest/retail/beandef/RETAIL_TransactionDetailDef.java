...
public class RETAIL_TransactionDetailDef extends BaseDef{
	...
	public static final String TABLE = "retail_transaction_detail";
	public static final String TABLE_PREFIX = "retailtd";
	public static final String MODULE_NAME = "retail_transaction_detail";	

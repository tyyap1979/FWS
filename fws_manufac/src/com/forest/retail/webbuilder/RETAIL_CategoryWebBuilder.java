...
public class RETAIL_CategoryWebBuilder extends BaseWebBuilder {
	private Logger logger = Logger.getLogger (RETAIL_CategoryWebBuilder.class);
	public RETAIL_CategoryWebBuilder(ShopInfoBean shopInfoBean,

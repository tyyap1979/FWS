	...
	private StringBuffer buildManufacturingListing() {
	    ...
	    try{
	    	...
	    	if(session==null){
		    	...
		    	buffer.append ("<li class='topnav'>");	    	
		    		buffer.append ("<a href='mfg_transaction.html' class='frames'>").append (ResourceUtil.getAdminResourceValue(_shopInfoBean.getBusiness(), MODULE_NAME, "transaction", _clientBean.getLocale ())).append ("</a>");
			    	buffer.append ("<ul class='subnav'>");				    	
				    	buffer.append ("<li><a href='mfg_transaction.html' class='icon edit'>").append (ResourceUtil.getAdminResourceValue(_shopInfoBean.getBusiness(), MODULE_NAME, "mfg_transaction", _clientBean.getLocale ())).append ("</a></li>");
				    	buffer.append ("<li><a href='mfg_po.html' class='icon edit'>").append (ResourceUtil.getAdminResourceValue(_shopInfoBean.getBusiness(), MODULE_NAME, "mfg_po", _clientBean.getLocale ())).append ("</a></li>");
			    	buffer.append ("</ul>");
		    	buffer.append ("</li>");
		    	...
		    	buffer.append ("<li class='topnav'>");	    	
			    	...
			    	buffer.append ("<ul class='subnav'>");				    	
				    	buffer.append ("<li><a href='mfg_receivepayment.html' class='icon book2'>").append (ResourceUtil.getAdminResourceValue(_shopInfoBean.getBusiness(), MODULE_NAME, "mfg_receivepayment", _clientBean.getLocale ())).append ("</a></li>");
				    	buffer.append ("<li><a href='mfg_statement.html' class='icon book2'>").append (ResourceUtil.getAdminResourceValue(_shopInfoBean.getBusiness(), MODULE_NAME, "mfg_statement", _clientBean.getLocale ())).append ("</a></li>");
				    	buffer.append ("<li><a href='mfg_debitnote.html' class='icon book2'>").append (ResourceUtil.getAdminResourceValue(_shopInfoBean.getBusiness(), MODULE_NAME, "mfg_debitnote", _clientBean.getLocale ())).append ("</a></li>");
				    	buffer.append ("<li><a href='mfg_creditnote.html' class='icon book2'>").append (ResourceUtil.getAdminResourceValue(_shopInfoBean.getBusiness(), MODULE_NAME, "mfg_creditnote", _clientBean.getLocale ())).append ("</a></li>");
				    	buffer.append ("<li><a href='mfg_supplierinvoice.html' class='icon book2'>").append (ResourceUtil.getAdminResourceValue(_shopInfoBean.getBusiness(), MODULE_NAME, "mfg_supplierinvoice", _clientBean.getLocale ())).append ("</a></li>");
				    	buffer.append ("<li><a href='mfg_paymentvoucher.html' class='icon book2'>").append (ResourceUtil.getAdminResourceValue(_shopInfoBean.getBusiness(), MODULE_NAME, "mfg_paymentvoucher", _clientBean.getLocale ())).append ("</a></li>");
				    	buffer.append ("<li><a href='mfg_report.html' class='icon cabin'>").append (ResourceUtil.getAdminResourceValue(_shopInfoBean.getBusiness(), MODULE_NAME, "mfg_report", _clientBean.getLocale ())).append ("</a></li>");
			    	buffer.append ("</ul>");
		    	buffer.append ("</li>");
		    	
		    	
		    	buffer.append ("<li class='topnav'>");	    	
		    		buffer.append ("<a href='mfg_custproduct.html' class='pictures'>").append (ResourceUtil.getAdminResourceValue(_shopInfoBean.getBusiness(), MODULE_NAME, "mfg_custproduct", _clientBean.getLocale ())).append ("</a>");
			    	buffer.append ("<ul class='subnav'>");
			    	
			    	buffer.append ("<li><a href='mfg_custproduct.html' class='icon list'>").append (ResourceUtil.getAdminResourceValue(_shopInfoBean.getBusiness(), MODULE_NAME, "mfg_custproduct", _clientBean.getLocale ())).append ("</a></li>");
			    	buffer.append ("<li><a href='mfg_prodoption.html' class='icon list'>").append (ResourceUtil.getAdminResourceValue(_shopInfoBean.getBusiness(), MODULE_NAME, "mfg_productopt", _clientBean.getLocale ())).append ("</a></li>");
			    	if("megatrend".equals(_shopInfoBean.getShopName())){
				    	buffer.append ("<li><a href='mfg_supplierproduct.html' class='icon list'>").append (ResourceUtil.getAdminResourceValue(_shopInfoBean.getBusiness(), MODULE_NAME, "mfg_supplierproduct", _clientBean.getLocale ())).append ("</a></li>");
				    	buffer.append ("<li><a href='mfg_supplierprodoption.html' class='icon list'>").append (ResourceUtil.getAdminResourceValue(_shopInfoBean.getBusiness(), MODULE_NAME, "mfg_supplierproductopt", _clientBean.getLocale ())).append ("</a></li>");
			    	}
			    	buffer.append ("<li><a href='mfg_raw.html' class='icon settings'>").append (ResourceUtil.getAdminResourceValue(_shopInfoBean.getBusiness(), MODULE_NAME, "mfg_raw", _clientBean.getLocale ())).append ("</a></li>");
			    	buffer.append ("<li><a href='mfg_grouping.html' class='icon settings'>").append (ResourceUtil.getAdminResourceValue(_shopInfoBean.getBusiness(), MODULE_NAME, "mfg_grouping", _clientBean.getLocale ())).append ("</a></li>");
			    	buffer.append ("</ul>");
		    	buffer.append ("</li>");
		    	...
		    	buffer.append ("<li><a href='supplier.html' class='icon house2'>").append (ResourceUtil.getAdminResourceValue(null, MODULE_NAME, "item.supplierprofile", _clientBean.getLocale ())).append ("</a></li>");
		    	buffer.append ("<li><a href='customer.html' class='icon house2'>").append (ResourceUtil.getAdminResourceValue(null, MODULE_NAME, "item.customerprofile", _clientBean.getLocale ())).append ("</a></li>");
		    	...
		    	buffer.append ("<li><a href='mfg_rawtoproduct.html' class='icon settings'>").append (ResourceUtil.getAdminResourceValue(_shopInfoBean.getBusiness(), MODULE_NAME, "mfg_rawtoproduct", _clientBean.getLocale ())).append ("</a></li>");
		    	...
		    	if(ass.getShopsWebSite(_shopInfoBean.getShopName()).size()==1){
			    	...
			    	buffer.append ("<ul class='subnav'>");
				    	...
				    	buffer.append ("<li><a href='clientuser.html' class='icon house2'>").append (ResourceUtil.getAdminResourceValue(null, MODULE_NAME, "item.members", _clientBean.getLocale ())).append ("</a></li>");
				    	buffer.append ("<li><a href='shipmentdomestic.html' class='icon house2'>").append (ResourceUtil.getAdminResourceValue(null, MODULE_NAME, "item.shipmentdomestic", _clientBean.getLocale ())).append ("</a></li>");
				    	buffer.append ("<li><a href='paymentmethod.html' class='icon house2'>").append (ResourceUtil.getAdminResourceValue(null, MODULE_NAME, "item.paymentmethod", _clientBean.getLocale ())).append ("</a></li>");

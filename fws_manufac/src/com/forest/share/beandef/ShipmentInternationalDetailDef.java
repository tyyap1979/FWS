...
public class ShipmentInternationalDetailDef extends BaseDef{
	...
	public static final String TABLE = "shipment_international_detail";
	public static final String TABLE_PREFIX = "shipmentinternationaldetail";
	public static String MODULE_NAME = "shipmentinternationaldetail";	

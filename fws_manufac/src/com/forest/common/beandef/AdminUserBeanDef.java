...
public class AdminUserBeanDef extends BaseDef{
	...
	public static DataObject usergroup = null;
	...
	public static String MODULE_NAME = "adminuser";	
	...
	public static void setAdditional() {				
		...
		companyid.searchOption = SearchConst.EQUAL;
		userid.searchOption = SearchConst.EQUAL;

...
public class MFG_CustProductSelectionDef extends BaseDef{	
	public static final String TABLE = "mfg_custproductselection";
	...
	public static String MODULE_NAME = "mfg_custproductselection";	

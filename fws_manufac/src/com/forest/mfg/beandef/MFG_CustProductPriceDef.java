...
public class MFG_CustProductPriceDef extends BaseDef{	
	public static final String TABLE = "mfg_custproductprice";
	...
	public static String MODULE_NAME = "mfg_custproductprice";	

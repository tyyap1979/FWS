...
public class MFG_CustProductImageDef extends BaseDef{
	public static final String TABLE = "mfg_custproductimage";
	...
	public static String MODULE_NAME = "mfg_custproductimage";	
